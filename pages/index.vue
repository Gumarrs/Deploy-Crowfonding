      ...
      <section class="container mx-auto pt-24">
        <div class="flex justify-between items-center">
          ...
          <div class="w-auto mt-5">
            <nuxt-link class="text-gray-900 hover:underline text-md font-medium" to="/dashboard"
              >View All</nuxt-link
            >
          </div>
        </div>
        <ApolloQuery :query="require('../graphql/getCampaignList.gql')">
        ...
        <div  class="grid grid-cols-3 gap-4 mt-3">
          ...
          <div
          v-for="Campaign in data.campagins" :key="Campaign.id"
          ...
          >
            <div class="item">
              ...
              <div class="item-meta">
                <h4 class="text-3xl font-medium text-gray-900 mt-1">
                 {{Campaign.name_project}}
                </h4>
                ...
                <div class="relative pt-4 progress-bar">
                  <div
                    class="overflow-hidden h-2 mb-2 text-xs flex rounded bg-gray-200 h-3 rounded-lg"
                  >
                    <div
              ...
              :to="`/projects/${Campaign.id}`"
                class="text-center mt-1 button-cta block w-full bg-orange-button hover:bg-green-button text-white font-semibold px-6 py-2 text-lg rounded-full"
              >
                Fund Now
              </nuxt-link>
            </div>
